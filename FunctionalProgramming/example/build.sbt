...
// mainClass in (Compile,run) := Some("mystl.BSets")
// mainClass in (Compile,run) := Some("mystl.Rationals")
// mainClass in (Compile,run) := Some("mystl.NLists")
// mainClass in (Compile,run) := Some("mystl.NStreams")
// mainClass in (Compile,run) := Some("mystl.Trees")
// mainClass in (Compile,run) := Some("mytypes.Nats")
// mainClass in (Compile,run) := Some("mytypes.Bools")
// mainClass in (Compile,run) := Some("myapps.NQueens")
// mainClass in (Compile,run) := Some("myapps.Books")
// mainClass in (Compile,run) := Some("myapps.Exprs")
// mainClass in (Compile,run) := Some("myapps.Simulations")
mainClass in (Compile,run) := Some("myapps.StreamApps")
// mainClass in (Compile,run) := Some("concur.CircularBufs")
